...
public class PoliceView {
	...
	protected void displayOptions(Model model) {
		System.out.println();
	...
	protected void dialog() {
		...
		// System.out.println("I also have option to exit from here and use
		// Public Transport from now on which is also environment friendly");
		System.out.println(
